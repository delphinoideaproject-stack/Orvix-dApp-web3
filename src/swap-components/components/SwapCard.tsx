...
export default function SwapCard({
  ...
  const buttonClass = {
    primary: 'bg-zinc-800 text-zinc-100 hover:bg-zinc-900 border border-[#555555] shadow-sm dark:bg-zinc-800 dark:border-[#CCCCCC] dark:text-zinc-100 dark:hover:bg-zinc-700 uppercase tracking-widest text-[10px] font-black',
    ...
    <div className={`relative z-10 mx-auto w-full ${embedded ? 'px-0 max-w-full' : 'px-5 md:px-0 md:max-w-2xl'}`}>
      ...
      <div className="flex justify-center -my-3 relative z-20">
        <motion.button
          ...
          className="w-10 h-10 rounded-full border border-border bg-bg-secondary hover:border-[#555555] dark:hover:border-[#CCCCCC] hover:bg-hover flex items-center justify-center transition-colors duration-200"
        >
          <ArrowDownUp size={16} className="text-black dark:text-white" />
        </motion.button>
      </div>
      ...
      {(isWrapMode || isUnwrapMode) && (
        <div className="mt-3 flex justify-center">
          <span className="px-3 py-1 rounded-full bg-accent-navy/30 border border-[#555555] dark:border-[#CCCCCC] text-accent-cyan text-xs font-medium">
