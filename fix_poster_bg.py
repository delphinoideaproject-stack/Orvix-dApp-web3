...
with open('/app/applet/src/components/TokenPosterCard.tsx', 'r') as f:
    content = f.read()
...
new_motion = r'''  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-sm text-zinc-700 dark:text-zinc-300 font-mono mb-4 drop-shadow-sm">${formatGlobalNumber(token.price)}</div>
        <div className="flex items-center justify-between text-xs">
...
with open('/app/applet/src/components/TokenPosterCard.tsx', 'w') as f:
    f.write(content)
